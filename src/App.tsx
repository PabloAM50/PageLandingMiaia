      ...
      <div className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-24">
          <div className="flex flex-col items-center text-center space-y-8">
            ...
            <button className="bg-gradient-to-r from-blue-500 to-teal-500 px-8 py-4 rounded-full text-lg font-semibold hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 flex items-center space-x-2">
        ...
        <div className="relative rounded-3xl bg-gradient-to-br from-blue-900 to-purple-900 p-12 overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <button 
              ...
              className="bg-white text-gray-900 px-8 py-4 rounded-full text-lg font-semibold hover:shadow-lg hover:shadow-white/25 transition-all duration-300"
            >
              Agenda una Demo
            </button>
          </div>
